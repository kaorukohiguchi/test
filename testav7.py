...
def sigmoid(x):
    return 1*(1/(1+np.exp(-s*(x-x0)))-xx)*1.41
...
#w update 2.40,A180
    ...
    #        plt.clim(-0.5,2)
            plt.savefig("sfigs/1nm"+str(i)+".jpg")
            plt.close()
        #plt.show()
            x = y = np.arange(0, self.n, 1)
            X, Y = np.meshgrid(x, y)
            ...
            fig = plt.figure(figsize=(8,8))
            ax = Axes3D(fig)
            Z0=(res[4,4,4,4,:,:,1,i]-res[4,4,4,4,8,8,1,i])*0.65+4
            Z0_5=(res[4,4,4,5,:,:,1,i]-res[4,4,4,5,8,8,1,i])*0.65+5
            Z0_3=(res[4,4,4,3,:,:,1,i]-res[4,4,4,3,8,8,1,i])*0.65+3
            ax.plot_surface(X,Y,Z0,alpha=alp,cmap=cm.Reds,vmin=3.9,vmax=4.7)
            ax.plot_surface(X,Y,Z0_5,alpha=alp,cmap=cm.Reds,vmin=4.9,vmax=5.7)
            ax.plot_surface(X,Y,Z0_3,alpha=alp,cmap=cm.Reds,vmin=2.9,vmax=3.7)
            plt.legend()
            ...
            ax.view_init(6,-60)
            plt.title(str(i*10)+"step",fontsize=font)
            plt.savefig("vfigs/1nm"+str(i)+".jpg")
            plt.close()
        ...
        #    plt.clim(-0.5,1.5)
            plt.title(str(i*10)+"step",fontsize=font)
            plt.savefig("csfigs/1nm"+str(i)+".jpg")
            plt.close()
            ...
            ax.view_init(6,-60)
            plt.title(str(i*10)+"step",fontsize=font)
            plt.savefig("cvfigs/1nm"+str(i)+".jpg")
            plt.close()
        ...
        #    plt.clim(-0.5,1.5)
            plt.title(str(i*10)+"step",fontsize=font)
            plt.savefig("abscsfigs/1nm"+str(i)+".jpg")
            plt.close()
        ...
        #    plt.clim(-0.5,1.5)
            plt.title(str(i*10)+"step",fontsize=font)
            plt.savefig("abscvfigs/1nm"+str(i)+".jpg")
            plt.close()
        plt.close()
